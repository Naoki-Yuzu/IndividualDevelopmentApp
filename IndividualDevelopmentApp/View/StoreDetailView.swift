...
class StoreDetailView: UIView {
    ...
    override func layoutSubviews() {
        ...
        splitView2.frame = CGRect(x: scrollView.bounds.width * 0.1, y: storeNameLabel.bounds.height + line.bounds.height + storeImageView.bounds.height + line2.bounds.height + 80 , width: scrollView.bounds.width * 0.8, height: 400)
        ...
        scrollView.contentSize = CGSize(width: splitView.bounds.width, height: storeNameLabel.bounds.height + line.bounds.height + storeImageView.bounds.height + line2.bounds.height + splitView2.bounds.height + 100)
...
//        storeImpresstionLabel.backgroundColor = UIColor(red: 250/255, green: 235/255, blue: 215/255, alpha: 1)
